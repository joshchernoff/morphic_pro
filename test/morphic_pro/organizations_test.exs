defmodule MorphicPro.OrganizationsTest do
  use MorphicPro.DataCase

  alias MorphicPro.Organizations

  describe "organizations" do
    alias MorphicPro.Organizations.Organization

    import MorphicPro.OrganizationsFixtures
