defmodule MorphicPro.TasksTest do
  use MorphicPro.DataCase

  alias MorphicPro.Tasks

  describe "tasks" do
    alias MorphicPro.Tasks.Task

    import MorphicPro.TasksFixtures
    ...
    test "create_task/1 with valid data creates a task" do
      valid_attrs = %{status: :todo, body: "some body", title: "some title"}
